...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="/code-igniter-app/css/bootstrap.min.css">
        <style>
            body {
                padding-top: 60px;
                padding-bottom: 40px;
        ...
        <link rel="stylesheet" href="/code-igniter-app/css/bootstrap-responsive.min.css">
        <link rel="stylesheet" href="/code-igniter-app/css/main.css">

        <script src="/code-igniter-app/js/vendor/modernizr-2.6.2.min.js"></script>
    </head>
    <body>
